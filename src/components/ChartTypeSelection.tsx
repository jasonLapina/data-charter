  ...
  return (
    <Box sx={{ maxWidth: 1200, margin: '0 auto', padding: 3 }}>
      ...
      <Typography variant="body1" paragraph align="center">
        Choose the type of chart you want to create. A preview is shown for each chart type.
      </Typography>
      ...
      <Grid container spacing={4} justifyContent="center">
          ...
          <Card sx={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
            <CardContent sx={{ flexGrow: 1 }}>
              ...
              <Typography variant="body2" color="text.secondary">
                Good for showing proportions of a whole, like spending by category.
              </Typography>
            </CardContent>
        ...
        <Grid item xs={12} sm={6} md={3}>
          <Card sx={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
            ...
            <CardMedia sx={{ height: 200, padding: 2 }}>
              <LineChartComponent data={lineChartPreviewData} isPreview={true} />
            </CardMedia>
            <CardContent>
              <Button 
                fullWidth 
        ...
        <Grid item xs={12} sm={6} md={3}>
          <Card sx={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
            ...
            <CardMedia sx={{ height: 200, padding: 2 }}>
              <AreaChartComponent data={areaChartPreviewData} isPreview={true} />
            </CardMedia>
            <CardContent>
              <Button 
                fullWidth 
